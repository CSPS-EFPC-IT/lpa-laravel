...
return [
    ...
    'form_section_groups' => [
        'planned_product' => [
            'label'       => 'Produit d\'apprentissage prévu|Produits d\'apprentissage prévus',
            'instruction' => 'Veuillez fournir le nombre de produits d\'apprentissage prévus dans le cadre de ce projet en utilisant les contrôles ci-dessous. Utilisez le bouton + pour ajouter une autre entrée à la liste.',
            'description' => 'Le nombre de produits d\'apprentissage prévus, par type, dans le cadre de ce projet.',
        ],
    ],
    'type' => [
        'label'       => 'Type',
