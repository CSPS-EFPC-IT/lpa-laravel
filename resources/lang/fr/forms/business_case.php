...
return [
    ...
    'form_section_groups' => [
        'spending' => [
            'label'       => 'Coût|Coûts',
            'instruction' => 'Veuillez fournir la ventillation des coûts du projet en utilisant les contrôles ci-dessous. Utilisez le bouton + pour ajouter une autre entrée à la liste.',
            'description' => 'La ventillation des coûts du projet.',
        ],
        'risk'     => [
            'label'       => 'Risque|Risques',
            'instruction' => 'Veuillez fournir la liste des risques pour l’École si ce projet n’est pas approuvé, le cas échéant, en utilisant les contrôles ci-dessous. Utilisez le bouton + pour ajouter une autre entrée à la liste.',
            'description' => 'La description des risques connus du projet.',
        ],
    ],
    'business_issue' => [
    ...
    'school_priorities' => [
        ...
        'description' => 'La liste des priorités de l’École auxquelles répond ce projet.',
    ],
    'request_origins' => [
    ...
    'spendings' => [
        ...
        'recurrence' => [
            'label'       => 'Récurrence',
            'instruction' => 'S\'il s\'agit d\'un coût récurrent, veuillez indiquer la fréquence dans le champ « Commentaires ».',
