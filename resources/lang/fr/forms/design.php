...
return [
    ...
    'form_section_groups' => [
        'expected_annual_participants' => [
            'label'       => 'Nombre prévu de participants|Nombre prévu de participants',
            'instruction' => 'Veuillez fournir les informations pour chaque région applicable en utilisant les contrôles ci-dessous. Utilisez le bouton + pour ajouter une autre entrée à la liste.',
            'description' => 'L\'estimation du nombre de participants par année.',
        ],
        'applicable_policy' => [
            'label'       => 'Politique applicable|Politiques applicables',
            'instruction' => 'Veuillez fournir la liste de toutes les politiques canadiennes traitées dans ce produit d\'apprentissage, le cas échéant, en utilisant les contrôles ci-dessous. Utilisez le bouton + pour ajouter une autre entrée à la liste.',
            'description' => 'Liste de toutes les politiques canadiennes traitées dans ce produit d\'apprentissage.',
        ],
        'additional_cost' => [
            'label'       => 'Coût additionel|Coûts additionels',
            'instruction' => 'Veuillez fournir la liste de tous les coûts qui dépassent le budget initial du projet, le cas échéant, en utilisant les contrôles ci-dessous. Utilisez le bouton + pour ajouter une autre entrée à la liste.',
            'description' => 'La liste de tous les coûts qui dépassent le budget initial du projet.'
        ],
    ],
    'learning_product_code' => [
        'label'       => 'Code du produit d\'apprentissage',
        'description' => 'Le code du produit d’apprentissage.',
        'help'        => 'Anciennement connu sous le nom de « legacy course code ». Tous les produits d\'apprentissage connexes ou intégrés doivent partager le même code. Par exemple, toutes les vidéos et tous les outils de travail intégrés dans un cours donné doivent partager le même code de produit d\'apprentissage.',
    ...
    'version' => [
        ...
        'help'        => 'Par exemple, un nouveau produit est la version 1.',
    ],
    'description' => [
        'label'       => 'Description',
    ...
    'is_required_training' => [
        'label'       => 'Formation indispensable / Fait partie des exigences d\'une attestation',
        'description' => 'Si le produit d’apprentissage est considéré ou non comme étant une « formation indispensable » ou « faisant partie des exigences d\'une attestation ».',
        'help'        => 'La définition de « formation indispensable » se retrouve dans la politique du Conseil du trésor en matière d’apprentissage, de formation et de perfectionnement.',
        'instruction' => 'Veuillez indiquer si le produit d’apprentissage est considéré comme étant une « formation indispensable » ou « faisant partie des exigences d\'une attestation ».',
    ],
    'total_duration' => [
        'label'       => 'Durée totale',
    ...
    'expected_annual_participants' => [
        'region' => [
            'label'       => 'Région',
            'description' => 'La région dans laquelle les participants suivront le cours.',
        ],
        'number' => [
            'label'       => 'Nombre prévu de participants (par année)',
            'description' => 'L\'estimation du nombre de participants par année.',
    ...
    'expected_annual_participant_comments' => [
        'label' => 'Commentaires sur le nombre prévu de participants'
    ],
    'applicable_policies' => [
        'applicable_policy' => [
            'label'       => 'Nom',
            'description' => 'Le nom d\'une politique canadienne traitée dans ce produit d\'apprentissage.',
            'instruction' => 'Veuillez saisir le nom d\'une politique canadienne traitée dans ce produit d\'apprentissage.',
        ]
    ],
    'content_source_type' => [
    ...
    'target_audience_knowledge_level' => [
        ...
        'description' => 'La description du niveau de connaissances du public cible.',
    ...
    'mandatory_prerequisites' => [
        'label'       => 'Produits d\'apprentissage obligatoires',
    ...
    'recommended_prerequisites' => [
        'label'       => 'Produits d’apprentissage recommandés',
    ...
    'prescribed_by_tbs' => [
        ...
        'help'        => '
            <ul>
                <li><span>Secrétariat du Conseil du Trésor du Canada</span> : Aussi appelé « Indispensable pour tous les ministères ».</li>
    ...
    'comments' => [
        ...
        'description' => 'Tout autre renseignement pertinent relatif à la conception.',
    ],
];
