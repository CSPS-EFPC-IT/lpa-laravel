...
return [
    ...
    'form_section_groups' => [
        'spending' => [
            'label'       => 'Cost|Costs',
            'instruction' => 'Please provide the cost breakdown using the controls below. Use the + button to add another entry to the list.',
            'description' => 'The project cost breakdown.',
        ],
        'risk'     => [
            'label'       => 'Risk|Risks',
            'instruction' => 'Please provide the list of risks for the School if this project does not go ahead, if any, using the controls below. Use the + button to add another entry to the list.',
            'description' => 'The description of the project\'s known risks.',
        ],
    ],
    'business_issue' => [
    ...
    'spendings' => [
        ...
        'recurrence' => [
            'label'       => 'Recurrence',
            'instruction' => 'If it is a recurring cost, please indicate the frequency in the "Comments" field.',
