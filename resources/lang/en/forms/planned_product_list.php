...
return [
    'form_title' => 'Planned Product List',
    'tabs'  => [
    ...
    'form_section_groups' => [
        'planned_product' => [
            'label'       => 'Planned Learning Product|Planned Learning Products',
            'instruction' => 'Please provide the number of learning products planned as part of this project using the controls below. Use the + button to add another entry to the list.',
            'description' => 'The number of learning products planned, per type, as part of this project.',
        ],
    ],
    'type' => [
        'label'       => 'Type',
