...
return [
    ...
    'form_section_groups' => [
        'expected_annual_participants' => [
            'label'       => 'Expected number of participants|Expected number of participants',
            'instruction' => 'Please provide the information for each applicable region using the controls below. Use the + button to add another entry to the list.',
            'description' => 'The estimate of the number of participants per year.',
        ],
        'applicable_policy' => [
            'label'       => 'Applicable Policy|Applicable Policies',
            'instruction' => 'Please provide the list of all Canadian policies addressed in this learning product, if any, using the controls below. Use the + button to add another entry to the list.',
            'description' => 'List of all Canadian policies addressed in this learning product.',
        ],
        'additional_cost' => [
            'label'       => 'Additional Cost|Additional Costs',
            'instruction' => 'Please provide the list of all costs that exceed the original project budget, if any, using the controls below. Use the + button to add another entry to the list.',
            'description' => 'The list of all costs that exceed the original project budget.'
        ],
    ],
    'learning_product_code' => [
        'label'       => 'Learning Product Code',
        'description' => 'The learning product code.',
        'help'        => 'This was formerly known as the "legacy course code." All related or embedded learning products must share the same Code. For example, all videos and job aids embedded in a given course must share the same Learning Product Code.',
    ...
    'version' => [
        ...
        'help'        => 'For example, a new product is version "1".',
    ],
    'description' => [
        'label'       => 'Description',
    ...
    'is_required_training' => [
        ...
        'instruction' => 'Please indicate whether the Learning Product is considered "required training" or "part of a certification"?',
    ],
    'total_duration' => [
    ...
    'registration_mode' => [
        ...
        'description' => 'The registration modes offered to participants.',
        'help'        => '
            <ul>
    ...
    'expected_annual_participants' => [
        'region' => [
            'label'       => 'Region',
            'description' => 'The region where participants will take the course.',
        ],
        'number' => [
            'label'       => 'Expected number of participants (per year)',
            'description' => 'The estimate of the number of participants per year.',
    ...
    'expected_annual_participant_comments' => [
        'label' => 'Comments on the expected number of participants'
    ],
    'applicable_policies' => [
        'applicable_policy' => [
            'label'       => 'Name',
            'description' => 'The name of a Canadian policy addressed in this learning product.',
            'instruction' => 'Please provide the name of a Canadian policy addressed in this learning product.',
        ]
    ],
    'content_source_type' => [
    ...
    'target_audience_knowledge_level' => [
        ...
        'description' => 'The description of the target audience\'s knowledge level.',
    ...
    'mandatory_prerequisites' => [
        'label'       => 'Mandatory Learning Products',
        'description' => 'The list of mandatory prerequisite learning product codes.',
        'instruction' => 'Please enter the list of learning product codes.',
    ],
    'recommended_prerequisites' => [
        'label'       => 'Recommended Learning Products',
        'description' => 'The list of recommended prerequisite learning product codes.',
        'instruction' => 'Please enter the list of learning product codes.',
    ],
    ...
    'comments' => [
        ...
        'description' => 'Any other relevant information about the design.',
    ],
];
