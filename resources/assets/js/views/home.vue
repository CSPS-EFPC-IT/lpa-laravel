<template>
  <div>
    <el-row type="flex" justify="center" :gutter="18">
      <el-col :span="18">
        <h2 v-if="isAdminOrOwner" v-html="$t('pages.home.title_owner')"></h2>
        <h2 v-else v-html="$t('pages.home.title_non_owner')"></h2>
      </el-col>
    </el-row>
    <el-row type="flex" justify="center" :gutter="18">
    ...
    <el-row type="flex" justify="center" :gutter="14">
      <el-col :span="14">
        <p v-if="isAdminOrOwner" v-html="$t('pages.home.instruction_owner')"></p>
        <p v-else v-html="$t('pages.home.instruction_non_owner')"></p>
        <p v-html="$t('pages.home.instruction_everyone')"></p>
      </el-col>
    </el-row>
    <!-- Actions -->
    <el-row
    ...
    >
      <el-col :span="7">
        ...
        >
          <span v-html="$t('pages.project_list.create_project')"></span>
        </el-button>
        <el-alert
          type="info"
          :title="$t('pages.home.description_project')"
          show-icon
          :closable="false"
        />
      </el-col>
      <el-col :span="7" :offset="1">
        ...
        >
          <span v-html="$t('pages.learning_product_list.create_learning_product')"></span>
        </el-button>
        <el-alert
          type="info"
          :title="$t('pages.home.description_learning_product')"
          show-icon
          :closable="false"
        />
      </el-col>
    ...
    >
      <el-col :span="12">
        <div>
          <i class="el-icon-warning"></i><span v-html="$t('pages.home.tip_owner')"></span>
        </div>
      </el-col>
    </el-row>
  </div>
