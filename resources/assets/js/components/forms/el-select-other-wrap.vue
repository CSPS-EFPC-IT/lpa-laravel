<template>
  <div class="el-select-other-wrap">
    ...
    <div class="el-input-other-wrap">
      ...
      >
        <span v-if="multiple">{{ $t('entities.form.others') }}</span>
        <span v-else>{{ $t('entities.form.other') }}</span>
      </el-checkbox>
      <input-wrap
        v-if="!localizable"
        ref="input"
  ...
  export default {
    ...
    props: {
      ...
      dataVvAsOther: {
        type: String,
        default() {
          return this.$t('entities.form.other');
        }
      },
      dataVvAsOtherEn: {
        type: String,
    ...
    methods: {
      ...
      updateInputValue(value) {
        // update parent data so that we can still v-model on the parent
        if (this.localizable) {
          this.$emit('update:modelOtherEn', value);
          this.$emit('update:modelOtherFr', value);
        } else {
