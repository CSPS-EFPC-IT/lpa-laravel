  ...
  <div class="material">
    ...
    >
      <input-wrap
        ...
        :data-vv-as="$t('forms.operational_details.materials.quantity.label')"
        type="number"
        :min="1"
        :max="100"
      />
    ...
    >
      <el-select-other-wrap
        ...
        :nameSelect="`${fieldNamePrefix}.material_item_id`"
        :dataVvAsSelect="$t('forms.operational_details.materials.material_item.label')"
        ...
        :nameOtherEn="`${fieldNamePrefix}.material_item_other_en`"
        :nameOtherFr="`${fieldNamePrefix}.material_item_other_fr`"
        :dataVvAsOtherEn="$t('forms.operational_details.materials.material_item_other.label')"
        :dataVvAsOtherFr="$t('forms.operational_details.materials.material_item_other.label')"
    ...
    >
      <el-select-wrap
        ...
        v-validate="'required'"
        :data-vv-as="$t('forms.operational_details.materials.material_denominator.label')"
        :name="`${fieldNamePrefix}.material_denominator_id`"
    ...
    >
      <el-select-wrap
        ...
        v-validate="'required'"
        :data-vv-as="$t('forms.operational_details.materials.material_location.label')"
        :name="`${fieldNamePrefix}.material_location_id`"
    ...
    >
      <yes-no
        ...
        v-validate="'required'"
        :data-vv-as="$t('forms.operational_details.materials.reusable.label')"
    ...
    >
      <input-localized
        ...
        :dataVvAsEn="$t('forms.operational_details.materials.notes.label')"
        :dataVvAsFr="$t('forms.operational_details.materials.notes.label')"
