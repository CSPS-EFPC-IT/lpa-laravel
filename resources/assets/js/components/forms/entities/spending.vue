  ...
  <div class="spending">
    ...
    >
      <el-select-wrap
        ...
        :data-vv-as="$t('forms.business_case.spendings.internal_resource.label')"
        v-validate="'required'"
    ...
    >
      <input-wrap
        ...
        v-validate="'required'"
        :data-vv-as="$t('forms.business_case.spendings.cost_description.label')"
    ...
    >
      <input-wrap
        ...
        :data-vv-as="$t('forms.business_case.spendings.cost.label')"
        v-mask="'######'"
        :min="0"
        :max="999999"
        type="number"
    ...
    >
      <el-select-wrap
        ...
        :data-vv-as="$t('forms.business_case.spendings.recurrence.label')"
        v-validate="'required'"
    ...
    >
      <input-wrap
        ...
        :data-vv-as="$t('forms.business_case.spendings.comments.label')"
