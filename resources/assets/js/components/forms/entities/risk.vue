  ...
  <div class="risk">
    ...
    >
      <el-select-other-wrap
        ...
        :dataVvAsSelect="$t('forms.business_case.risks.risk_type.label')"
        ...
        :dataVvAsOther="$t('forms.business_case.risks.risk_type_other.label')"
    ...
    >
      <input-wrap
        ...
        v-validate="'required'"
        :data-vv-as="$t('forms.business_case.risks.risk_rationale.label')"
