@form(['form' => $data])
    ...
    @form_section(['title' => trans('forms/business_case.tabs.costs')])
        ...
        {{-- Cost Breakdown --}}
        <h4>{{ trans_choice('forms/business_case.form_section_groups.spending.label', 2) }}</h4>
        @forelse($formData['spendings'] as $spending)
            @field_group(['field' => 'business_case.form_section_groups.spending.label', 'index' => $loop->iteration])
                <dl>
    ...
    @form_section(['title' => trans('forms/business_case.tabs.risk')])
        ...
        @forelse($formData['risks'] as $risk)
            @field_group(['field' => 'business_case.form_section_groups.risk.label', 'index' => $loop->iteration])
                <dl>
