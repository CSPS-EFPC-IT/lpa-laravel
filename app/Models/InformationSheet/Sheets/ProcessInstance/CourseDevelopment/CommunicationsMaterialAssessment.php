...
class CommunicationsMaterialAssessment
{
    /**
    ...
    {
        // Create Communication Material Assessment information sheet for process instance.
        InformationSheet::createFromDefinition(
            $event->processInstance, 'course-development.communications-material-assessment'
        );
    }

    /**
     * Return data for a Development Assessment information sheet.
     *
