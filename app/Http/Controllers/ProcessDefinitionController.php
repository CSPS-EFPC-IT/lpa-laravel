...
class ProcessDefinitionController extends APIController
{
    ...
    public function startProcess(ProcessDefinition $processDefinition)
    {
        ...
        $sendNotifications = filter_var(request()->get('send_notifications'), FILTER_VALIDATE_BOOLEAN);
        $this->authorize('start-process', [$entity, $processDefinition]);
        $processInstance = Process::startProcess($processDefinition, $entity, $sendNotifications)->getProcessInstance();
