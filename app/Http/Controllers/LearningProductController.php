...
class LearningProductController extends APIController
{
    ...
    public function show(LearningProduct $learningProduct)
    {
        ...
        return $this->respond(
            new LearningProductResource($learningProduct)
        );
    }
    ...
    public function edit(LearningProduct $learningProduct)
    {
        ...
        // Get available states for the learning product.
        $states = State::whereEntityType($learningProduct->type->name_key)->get();
