...
class ProcessManager
{
     ...
     */
    public function startProcess($processDefinition, $entity, $sendNotifications = null)
    {
        ...
        try {
            ...
            $this->processInstance = new ProcessInstance([
                ...
                'send_notifications'         => $sendNotifications ?? config('mail.send_process_notifications'),
                'created_by'                 => $user->id,
                'updated_by'                 => $user->id,
            ]);
