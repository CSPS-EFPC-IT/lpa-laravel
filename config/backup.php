...
return [
    ...
    'backup' => [
        ...
        /*
         * Whether or not daily backup should be running.
         */
        'active' => env('BACKUP_ACTIVE', false),

        /*
         * Time of the day on which the backups get executed.
         */
        'time_of_day' => env('BACKUP_TIME_OF_DAY', '0:00'),

        /*
         * The name of this application. You can use this name to monitor
         * the backups.
         */
        'name' => env('BACKUP_NAME', 'lpa'),
